...
public class Wheels_Hover
{
    ...
    public Wheels_Hover(Side side, Position position, float width, float scale, float offsetX, float offsetY, float offsetZ)
    {
    ...
    public Wheels_Hover(Side side, Position position, float offsetX, float offsetZ)
    {
        this(side, position, 2.0F, 1.0F, offsetX, 0F, offsetZ);
    }

    public Wheels_Hover(Side side, Position position, float offsetX, float offsetZ, float scale){
        this(side, position, 2.0F, scale, offsetX, 0F, offsetZ);
    }

    public Wheels_Hover(Side side, Position position, float offsetX, float offsetY, float offsetZ, float scale)
    {
