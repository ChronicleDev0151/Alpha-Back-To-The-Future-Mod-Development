...
public class DefaultDoors
{
    ...
    public DefaultDoors(Side side, Position position, float width, float scale, float offsetX, float offsetY, float offsetZ)
    {
    ...
    public DefaultDoors(Side side, Position position, float offsetX, float offsetZ)
    {
        this(side, position, 2.0F, 1.0F, offsetX, 0F, offsetZ);
    }

    public DefaultDoors(Side side, Position position, float offsetX, float offsetZ, float scale)
    {
        this(side, position, 2.0F, scale, offsetX, 0F, offsetZ);
    }

    public DefaultDoors(Side side, Position position, float offsetX, float offsetY, float offsetZ, float scale)
    {
