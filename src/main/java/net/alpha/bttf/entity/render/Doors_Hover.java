...
public class Doors_Hover
{
    ...
    public Doors_Hover(Side side, Position position, float width, float scale, float offsetX, float offsetY, float offsetZ)
    {
    ...
    public Doors_Hover(Side side, Position position, float offsetX, float offsetZ)
    {
        this(side, position, 2.0F, 1.0F, offsetX, 0F, offsetZ);
    }

    public Doors_Hover(Side side, Position position, float offsetX, float offsetZ, float scale)
    {
        this(side, position, 2.0F, scale, offsetX, 0F, offsetZ);
    }

    public Doors_Hover(Side side, Position position, float offsetX, float offsetY, float offsetZ, float scale)
    {
    ...
    public void render(EntityTimeTravelVehicle vehicle, float partialTicks) {
        ...
        GlStateManager.pushMatrix();
        {
            ...
            GlStateManager.pushMatrix();
            {
                ...
                Minecraft.getMinecraft().getRenderItem().renderItem(vehicle.door_1, ItemCameraTransforms.TransformType.NONE);
            }
