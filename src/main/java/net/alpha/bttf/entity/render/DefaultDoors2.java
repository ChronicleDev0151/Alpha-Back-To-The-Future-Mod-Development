...
public class DefaultDoors2
{
    ...
    public DefaultDoors2(Side side, Position position, float width, float scale, float offsetX, float offsetY, float offsetZ)
    {
    ...
    public DefaultDoors2(Side side, Position position, float offsetX, float offsetZ)
    {
        this(side, position, 2.0F, 1.0F, offsetX, 0F, offsetZ);
    }

    public DefaultDoors2(Side side, Position position, float offsetX, float offsetZ, float scale)
    {
        this(side, position, 2.0F, scale, offsetX, 0F, offsetZ);
    }

    public DefaultDoors2(Side side, Position position, float offsetX, float offsetY, float offsetZ, float scale)
    {
        this(side, position, 2.0F, scale, offsetX, offsetY, offsetZ);
    }

    public void render(EntityDefaultVehicle vehicle, float partialTicks) {
    ...
    private float getWheelRotation(EntityDefaultVehicle vehicle, float partialTicks)
    {
        if(position == DefaultDoors2.Position.LEFT)
        {
