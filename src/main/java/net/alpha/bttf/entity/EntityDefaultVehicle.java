...
public abstract class EntityDefaultVehicle extends EntityVehicle
{
    private static final DataParameter<Boolean> DRIFTING = EntityDataManager.createKey(EntityDefaultVehicle.class, DataSerializers.BOOLEAN);
    ...
    public EntityDefaultVehicle(World worldIn)
    {
        super(worldIn);
    }
