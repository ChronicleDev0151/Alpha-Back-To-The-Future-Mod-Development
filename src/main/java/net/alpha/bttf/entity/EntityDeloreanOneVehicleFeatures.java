...
public abstract class EntityDeloreanOneVehicleFeatures extends EntityTimeTravelVehicle
{
    ...
    private static final DataParameter<Boolean> DRIFTING = EntityDataManager.createKey(EntityDeloreanOneVehicleFeatures.class, DataSerializers.BOOLEAN);
    ...
    protected EntityDeloreanOneVehicleFeatures(World worldIn) {
        super(worldIn);
    }
}
